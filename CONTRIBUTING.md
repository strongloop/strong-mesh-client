...
Thank you for your interest in `strong-mesh-client`, an open source project
administered by StrongLoop.

Contributing to `strong-mesh-client` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-mesh-client)
